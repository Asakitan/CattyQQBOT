...
# P5 临界点要快推 (2 轮) / P6 高潮峰值要给 2 轮真喷射 / P8 余韵无限保持
# 主人 2026-05-27 #3 项: P6 不该 stuck=3 轮 — 应该 P6→P7 立即
# 主人 2026-05-28: P6 thr 1 → 2 — 之前 1 轮 stuck 直接 prefill P7 overstim '停太敏感',
# 跳过了真高潮喷射 (痉挛/尖叫/灌满). 给 P6 留 2 轮让模型真写出 climax 物理细节.
_PHASE_STUCK_THRESHOLDS: dict[int, int] = {
    ...
    4: 2,   # P4 迎合 (2 轮就该推 P5)
    5: 2,   # P5 临界 (2 轮就该推 P6)
    6: 2,   # P6 高潮峰值 (2 轮真喷射, 然后推 P7 overstim)
