...
class AffectionStore:
    ...
    def persona_hint(self, user_id: str | int) -> str:
        ...
        统一约束:笨猫自称固定用『人家 / 奴 / 猫猫 / 笨猫』,绝不裸开头"喵~..."
        丢自称;『主人』这个称呼只给真正的主人(catty_owner_qq),别人用『你』。
        """
        uid = str(user_id)
        if self.is_owner(uid):
            return (
                ...
                "自称用『人家』『奴』『猫猫』,适合主人场景的『奴』(姿态放低撒娇)可以多用,"
