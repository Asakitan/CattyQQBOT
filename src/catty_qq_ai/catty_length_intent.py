...
为什么需要:
现有规则太硬: 用户问"代码报错怎么办" 默认也 ≤50 字, AI 容易吞掉技术细节;
...
_LENGTH_RULES: list[tuple[str, tuple[str, ...], str]] = [
    ...
    (
        ...
        "**总字数 ≤50 字, 1-2 句** 顺毛 + 软软接住 + 留 hook, 不要凑长. "
...
_INTENT_HINTS["medium"] = (
    "**本轮推荐 medium** (非学术 ≤50 字, 1-2 句): 情绪+信息+收尾, "
    "比 short 多 1 个语义点, 但仍别凑长."
)
_INTENT_HINTS["long"] = (
